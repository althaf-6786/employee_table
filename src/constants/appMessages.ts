...
export const SCRAPING_SUCCESS = "Scraping completed successfully";
export const CRAWLING_SUCCESS = "Crawling completed successfully";
export const INVALID_PAYLOAD_FOR_SCRAPING = "Invalid payload for scraping";
export const URL_NOT_FOUND = "Please provide a url with formats";
